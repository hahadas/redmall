	...
	<view @touchmove.stop.prevent="clear" v-if="showPopup">
		...
		<view class="popup_content">
			...
			<view class="explain_text">
				...
				<view class="line">
					你可以阅读
					<navigator :url="protocolPath" class="path" hover-class="navigator-hover">《服务协议》</navigator>和<navigator :url="policyPath" class="path" hover-class="navigator-hover">《隐私政策》</navigator>了解详细信息。如您同意，请点击"同意"入驻为redMall商家。
				</view>
				<view style="color: #d90808;">(入驻成功后,商家端的账号密码为当前已注册的redMall账号密码)</view>
			</view>
